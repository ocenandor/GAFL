...
def get_params():
    ...
    # multigafl
    params.update({'multi_gafl': [configs['model_parameters']['classification']['ResNet']['multi_gafl'], []] })
    #params.update({'multi_gafl' : tuple(map(int, configs['model_parameters']['classification']['ResNet']['multi_gafl'].split(', ')))}) 
